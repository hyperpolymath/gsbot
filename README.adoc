...
image:https://img.shields.io/badge/Standards-Open-brightgreen.svg[Open Standards,link=STANDARDS.adoc]
image:https://img.shields.io/badge/Neurosymbolic-Kautz--6-purple.svg[Neurosymbolic Kautz-6,link=ECOSYSTEM.adoc]
image:https://img.shields.io/badge/Pareto-Optimal-yellow.svg[Pareto Optimality,link=ECOSYSTEM.adoc]
image:https://img.shields.io/badge/Eclexia-Pilot-orange.svg[Eclexia Pilot,link=ECOSYSTEM.adoc]
image:https://img.shields.io/badge/Stack-Rust%2FSPARK%20%2B%20Zig-ff69b4.svg[Rust/SPARK+Zig]
...
The *G*arment *S*ustainability *Bot* — yes, the name is a gentle double
entendre, and yes we mean it: the sustainability sweet-spot in fashion
production, where material science, maths and engineering meet
triple-bottom-line ethics (permaculture fairness, environmental
stewardship, real economics).  A neurosymbolic (Kautz level-6) chat +
dashboard for fashion and textiles specialists, with materials
impact scoring, Pareto-optimal trade-off analysis, live catalogue &
safety feeds over open standards, and a detachable assembly panel for
swappable ecological-vs-economic costing.

See link:ECOSYSTEM.adoc[Ecosystem & Vision] for the dogfood story and
link:STANDARDS.adoc[Standards Map] for the open-standards inventory.

[NOTE]

====
Canonical home for GSBot is this repo: `https://github.com/hyperpolymath/gsbot`.
The fleet checkout under `gitbot-fleet/bots/gsbot` is a historical mirror and
...
image:https://img.shields.io/badge/RSR-Bronze-cd7f32.svg[RSR Compliant,link=RSR.adoc]
image:https://img.shields.io/badge/TPCF-Perimeter%203-success.svg[TPCF Perimeter 3,link=TPCF.adoc]
...
+-- docs/
|   +-- API.adoc                # Full command reference
...
* link:docs/API.adoc[API Reference] - Complete command documentation
* link:docs/ARCHITECTURE.adoc[Architecture] - System design and patterns
* link:docs/DEPLOYMENT.adoc[Deployment] - Production deployment guide
* link:ROADMAP.adoc[Roadmap] - Development roadmap and future features

== Contributing

See link:.github/CONTRIBUTING.md[CONTRIBUTING.md] for development guidelines.
