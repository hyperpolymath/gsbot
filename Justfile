...
rsr-check:
    ...
    @test -f RSR.adoc && echo "  ✓ RSR.adoc" || echo "  ✗ RSR.adoc"
    @test -f TPCF.adoc && echo "  ✓ TPCF.adoc" || echo "  ✗ TPCF.adoc"
    @test -f ECOSYSTEM.adoc && echo "  ✓ ECOSYSTEM.adoc" || echo "  ✗ ECOSYSTEM.adoc"
    @test -f STANDARDS.adoc && echo "  ✓ STANDARDS.adoc" || echo "  ✗ STANDARDS.adoc"
    @test -f .env.example && echo "  ✓ .env.example" || echo "  ✗ .env.example"
    @test -f .well-known/security.txt && echo "  ✓ .well-known/security.txt" || echo "  ✗ .well-known/security.txt"
