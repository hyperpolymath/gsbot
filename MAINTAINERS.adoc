...
See TPCF.adoc for full Tri-Perimeter Contribution Framework details.
...
* Review .github/CONTRIBUTING.md for contribution guidelines
* See CODE_OF_CONDUCT.adoc for community expectations
