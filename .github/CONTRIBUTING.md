...
git clone <https://github.com/hyperpolymath/gsbot.git> cd gsbot
...
toolbox create gsbot-dev toolbox enter gsbot-dev \# Install dependencies
manually
...
gsbot/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \# Library code
...
flake (Perimeter 1) └── Justfile \# Task runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/gsbot/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/gsbot/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/gsbot/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/gsbot/labels/perimeter-3) — Community sandbox scope
