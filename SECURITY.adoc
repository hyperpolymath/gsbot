...
[arabic]
. Navigate to
https://github.com/hyperpolymath/gsbot/security/advisories/new[Report a
Vulnerability]
...
link:SECURITY-ACKNOWLEDGMENTS.adoc[Security Acknowledgments] (unless they
prefer anonymity).
...
https://github.com/hyperpolymath/gsbot/security/advisories[Security
Advisories]
...
|Purpose |Contact
|*Security issues*
|https://github.com/hyperpolymath/gsbot/security/advisories/new[Report
via GitHub] or j.d.a.jewell@open.ac.uk

|*General questions*
|https://github.com/hyperpolymath/gsbot/discussions[GitHub Discussions]
...
_Thank you for helping keep Gsbot and its users safe._ 🛡️
