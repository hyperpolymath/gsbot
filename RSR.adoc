...
* ✅ README.adoc - Comprehensive project overview
* ✅ LICENSE - Mozilla Public License 2.0
* ✅ SECURITY.adoc - Security policy and vulnerability reporting
* ✅ .github/CONTRIBUTING.md - Contribution guidelines
* ✅ CODE_OF_CONDUCT.adoc - Community conduct expectations
* ✅ MAINTAINERS.adoc - Maintainer information and governance
* ✅ CHANGELOG.adoc - Version history and changes
...
* ✅ TPCF.adoc - Tri-Perimeter Contribution Framework declaration
...
Reproducible builds (Nix/Guix) - Multi-language verification - Security
audit
...
----
# Check documentation
ls -la *.adoc .well-known/ .github/CONTRIBUTING.md CLAUDE.md GEMINI.md
...
* *About TPCF*: See TPCF.adoc
* *About contributing*: See .github/CONTRIBUTING.md
* *About the project*: See README.adoc
